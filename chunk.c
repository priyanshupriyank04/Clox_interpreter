...
{
    FREE_ARRAY(int, chunk->lines,chunk->capacity); //int array of code line information is reset once the chunk memory is freed just as same as the bytecode array
